...
print_contact_links <- function(responses, i){
  ...
  return(paste(twitter,feedback, public))
}
```
...
responses <- responses %>% arrange(Timestamp)
...
10:40 Presentation about tools for Reproducible Research by [Dr. Anna Krystalli](http://www.annakrystalli.com/)
...
<br>
`r icon:: fa("twitter", colour = "#09754a")` [ReproHackNL](https://twitter.com/ReproHackNL)
